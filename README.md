...
レジャーホテルでは、通常の宿泊施設と異なり、ユーザーが「今すぐ利用できる部屋」を探すケースが多くあります。

一方で、実際の空室状況や清掃中の部屋、まもなく利用可能になる部屋の情報は、電話確認や現地到着後の確認に依存しやすく、ユーザーと店舗の双方に手間が発生します。

LOCOROは、このようなレジャーホテル特有のリアルタイム性の高い利用シーンに着目し、部屋の状態管理とユーザー側の空室確認をスムーズにすることを目的として開発しています。

将来的には、短時間利用に合わせた予約・キープ機能や、店舗側の運用負担を減らす管理機能を備えたSaaSとして展開することを想定しています。
